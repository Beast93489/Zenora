...
class _JournalScreenState extends State<JournalScreen>
  ...
  // Random prompts to fill empty space and inspire writing
  final List<String> _prompts = [
    'spill the tea bestie, what happened today? ☕',
  ...
  final Map<String, Map<String, dynamic>> _emotionData = {
    'joy':      {'emoji': '😊', 'color': Color(0xFFFFB800), 'label': 'Joyful',
      'genZ': 'you\'re eating and leaving no crumbs fr 🔥'},
...
RESPONSE: [a warm, empathetic 2-3 sentence response to the person. Be genuine and supportive.]
...
Journal entry: "$text"'''
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint('Journal Gemini error: ${response.body}');
  ...
  void _analyzeEntry() async {
    if (_controller.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('kuch toh likho yaar! 😤',
    ...
    if (_wordCount < 5) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('thoda aur likho, 5+ words chahiye 📝',
            style: TextStyle(color: Colors.white)),
        backgroundColor: Color(0xFF5C2D91),
        behavior: SnackBarBehavior.floating,
      ));
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: _detectedEmotion.isEmpty
                ...
                : [
                    _gradientColor.withValues(alpha: 0.4),
                ...
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(_getFormattedDate(),
                      style: const TextStyle(
                          color: Color(0xFF9B59F5), fontSize: 11)),
                ]),
                const Spacer(),
                // Word count badge
                Container(
                ...
                child: Column(children: [
                  ...
                  if (_wordCount > 0 && _detectedEmotion.isEmpty) ...[
                    Row(children: [
                      Expanded(
                        child: ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            value: (_wordCount / 20).clamp(0.0, 1.0),
                            minHeight: 4,
                      ...
                      Text(
                        _wordCount >= 20
                            ? 'ready to analyse! ✅'
                            : '${20 - _wordCount} more words for best results',
                        style: TextStyle(
                            color: _wordCount >= 20
                                ? const Color(0xFF27AE60)
                                : Colors.white38,
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      [
                                        ...
                                        'decoding your vibe fr...',
                                        'asking Gemini ji... 🙏',
                                        'manifesting your result...',
                  ...
                  if (_detectedEmotion.isNotEmpty && emotionInfo != null)
                    ScaleTransition(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: (_gradientColor).withValues(alpha: 0.15),
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(
                              color: _gradientColor.withValues(alpha: 0.4)),
                        ),
                        child: Column(children: [
                          Row(children: [
                          ...
                          Row(children: [
                            Container(
                              ...
                              child: const Text('⚡ +10 Zeno Points!',
                                  style: TextStyle(
                  ...
                  if (_detectedEmotion.isEmpty) ...[
                    Container(
                      ...
                      child: Row(children: [
                        Text(_currentTip['emoji'] as String,
                            style: const TextStyle(fontSize: 20)),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Text(_currentTip['tip'] as String,
                              style: const TextStyle(
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        const Expanded(
                          child: Text(
                            'Journal entries give +10 Zeno Points — most of any mode! Log daily for max streak 🔥',
                            style: TextStyle(
                                color: Color(0xFF9B59F5),
                                fontSize: 12,
                                height: 1.4),
