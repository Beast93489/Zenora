...
class _EmojiBoardScreenState extends State<EmojiBoardScreen>
    ...
    for (final category in _emojiCategories.values) {
      for (final item in category) {
        if (_selectedEmojis.contains(item['emoji'])) {
          final e = item['emotion'] as String;
  ...
  String _getResponse(String emotion) {
    final responses = {
      'joy':      "Your emoji selection radiates positive energy! 🌟 These feelings of happiness are wonderful — hold onto them!",
      'sadness':  "It's okay to feel this way. 💙 Your emotions are valid. Take it easy today — be gentle with yourself.",
      'anger':    "I can see you're feeling frustrated right now. 🌊 Take a few deep breaths. This feeling will pass.",
      'fear':     "Anxiety can feel overwhelming, but you're stronger than you think. 💪 Try the 5-4-3-2-1 grounding technique.",
      'surprise': "Life is full of unexpected moments! ✨ Remember that you have the strength to adapt and grow.",
      'neutral':  "Feeling balanced today? 😌 That's perfectly fine — use this calm energy to focus on something meaningful.",
    };
  ...
  void _analyzeBoard() async {
    ...
    FirebaseService.saveMoodEntry(
      mode: 'emoji_board',
      emotion: emotion,
      emotionLabel: _emotionData[emotion]?['label'] as String? ?? 'Neutral',
  ...
  void _toggleEmoji(String emoji) {
    setState(() {
      if (_selectedEmojis.contains(emoji)) {
        ...
        if (_selectedEmojis.length < 6) _selectedEmojis.add(emoji);
      }
      _detectedEmotion = '';
      _aiResponse = '';
    });
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: Row(children: [
                ...
                const Text('😊 Emoji Board',
                    style: TextStyle(color: Colors.white,
                        fontSize: 22, fontWeight: FontWeight.bold)),
                const Spacer(),
                Text('${_selectedEmojis.length}/6',
                    ...
                    if (_selectedEmojis.isNotEmpty) ...[
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          Wrap(
                            spacing: 8,
                            children: _selectedEmojis.map((e) =>
                              ScaleTransition(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              gradient: const LinearGradient(colors: [
                                Color(0xFF5C2D91), Color(0xFF007A7A)]),
                              borderRadius: BorderRadius.circular(16),
                            ),
                            child: Center(
                              child: _isAnalyzing
                    ...
                    if (emotionInfo != null) ...[
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          ...
                          const SizedBox(height: 8),
                          Text('Feeling ${emotionInfo['label']}',
                              style: TextStyle(
                                  color: emotionInfo['color'] as Color,
                                  fontSize: 20,
                                  fontWeight: FontWeight.bold)),
