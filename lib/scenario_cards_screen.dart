          ...
          children: [
            ...
            Text('Loading scenarios...',
                style: TextStyle(
                    ...
                    fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
            Text('Fetching fresh situations just for you',
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('${scenario['category']} • AI Generated',
              style: const TextStyle(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(scenario['scenario'] as String,
                        textAlign: TextAlign.center,
                        style: const TextStyle(
                            color: Colors.white,
                            fontSize: 17,
        ...
        child: Column(children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                const Text('Your Reaction Breakdown',
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 15,
                        fontWeight: FontWeight.bold)),
